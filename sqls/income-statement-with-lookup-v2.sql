-- Income Statement Report for BOT API (Highly Optimized - Single Scan)
-- Uses INCOME_STATEMENT_GL_LOOKUP table + handles patterns in one pass
-- Performance: Single table scan instead of two separate scans

WITH all_transactions AS (
    -- Single scan of GLI_TRX_EXTRACT with all filtering
    SELECT 
    ...
    WHERE gte.TRN_DATE >= CURRENT_DATE - 180 DAYS  -- Last 6 months
        AND (
