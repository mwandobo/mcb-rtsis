SELECT VARCHAR_FORMAT(CURRENT_TIMESTAMP, 'DDMMYYYYHH24MI') AS reportingDate,
       ...
       wela.CURR_SUB_CLASS AS assetClassificationCategory,
       wela.PRODUCT_DESC AS sectorSnaClassification,
...
--        COALESCE(WRITE_OFF_DATE, OV_EXP_DT, ACC_EXP_DT)     AS realEndDate,
--        (NRM_BALANCE + OV_BALANCE)                          AS orgOutstandingAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN (NRM_BALANCE + OV_BALANCE)
--            ELSE NULL
--            END                                             AS usdOutstandingAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN (NRM_BALANCE + OV_BALANCE) * 2500 -- <<< replace with your rate
--            ELSE
--                (NRM_BALANCE + OV_BALANCE)
--            END                                             AS tzsOutstandingAmount,
--
--
--        DRAWDOWN_FST_DT AS latestCustomerCreditDate,
--        DRAWDOWN_FST_AMN AS latestCreditAmount,
--        SELECTED_BANK_RATE AS primeLendingRate,
--        FINAL_INTEREST AS annualInterestRate,
--        COLLATERAL_OM_VALUE AS collateralPledged,
--        COLLATERAL_OM_VALUE AS orgCollateralValue,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN COLLATERAL_OM_VALUE
--            ELSE NULL
--            END                                             AS usdCollateralValue,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN COLLATERAL_OM_VALUE* 2500 -- <<< replace with your rate
--            ELSE
--                COLLATERAL_OM_VALUE
--            END                                             AS tzsCollateralValue,
--        CASE WHEN ACC_DRAWDOWN_STS = 'R' THEN 1 ELSE 0 END AS restructuredLoans,
--        OVERDUE_DAYS AS pastDueDays,
--        OV_BALANCE AS pastDueAmount,
--        NRM_ACR_INT_BAL + OV_ACR_NRM_INT_BAL + OV_ACR_PNL_INT_BAL AS orgAccruedInterestAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN NRM_ACR_INT_BAL + OV_ACR_NRM_INT_BAL + OV_ACR_PNL_INT_BAL
--            ELSE NULL
--            END                                             AS usdAccruedInterestAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN NRM_ACR_INT_BAL + OV_ACR_NRM_INT_BAL + OV_ACR_PNL_INT_BAL * 2500 -- <<< replace with your rate
--            ELSE
--                NRM_ACR_INT_BAL + OV_ACR_NRM_INT_BAL + OV_ACR_PNL_INT_BAL
--            END                                             AS tzsAccruedInterestAmount,
--         OV_RL_PNL_INT_BAL + OV_URL_PNL_INT_BAL AS orgPenaltyChargedAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  OV_RL_PNL_INT_BAL + OV_URL_PNL_INT_BAL
--            ELSE NULL
--            END                                             AS usdPenaltyChargedAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  OV_RL_PNL_INT_BAL + OV_URL_PNL_INT_BAL * 2500 -- <<< replace with your rate
--            ELSE
--                OV_RL_PNL_INT_BAL + OV_URL_PNL_INT_BAL
--            END                                             AS tzsPenaltyChargedAmount,
--        TOT_COMMISSION_AMN AS orgLoanFeesChargedAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  TOT_COMMISSION_AMN
--            ELSE NULL
--            END                                             AS usdLoanFeesChargedAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  TOT_COMMISSION_AMN * 2500 -- <<< replace with your rate
--            ELSE
--                TOT_COMMISSION_AMN
--            END                                             AS tzsLoanFeesChargedAmount,
--        TOT_EXPENSE_AMN AS orgLoanFeesPaidAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  TOT_EXPENSE_AMN
--            ELSE NULL
--            END                                             AS usdLoanFeesChargedAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  TOT_EXPENSE_AMN * 2500 -- <<< replace with your rate
--            ELSE
--                TOT_EXPENSE_AMN
--            END                                             AS tzsLoanFeesChargedAmount,
--        INSTALL_FIXED_AMN AS orgTotMonthlyPaymentAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  INSTALL_FIXED_AMN
--            ELSE NULL
--            END                                             AS usdTotMonthlyPaymentAmount,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  INSTALL_FIXED_AMN * 2500 -- <<< replace with your rate
--            ELSE
--                INSTALL_FIXED_AMN
--            END                                             AS tzsTotMonthlyPaymentAmount,
--        TOT_NRM_INT_AMN + TOT_PNL_INT_AMN AS orgInterestPaidTotal,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  TOT_NRM_INT_AMN + TOT_PNL_INT_AMN
--            ELSE NULL
--            END                                             AS usdInterestPaidTotal,
--        CASE
--            WHEN wela.CURRENCY = 'USD'
--                THEN  TOT_NRM_INT_AMN + TOT_PNL_INT_AMN * 2500 -- <<< replace with your rate
--            ELSE
--                TOT_NRM_INT_AMN + TOT_PNL_INT_AMN
--            END                                             AS tzsInterestPaidTotal,
--        CURR_SUB_CLASS AS assetClassificationCategory,
--        PRODUCT_DESC AS sectorSnaClassification,
--        ACC_STATUS AS negStatusContract,
--        CUST_TYPE AS customerRole,
--        PROVISION_AMOUNT AS allowanceProbableLoss,
--        PROVISION_AMN AS botProvision
...
--        wela.PROVISION_AMOUNT                               AS botProvision
