@echo off
REM Investment Debt Securities Pipeline Runner for Windows
REM This script sets up the environment and runs the pipeline

echo ========================================
echo Investment Debt Securities Pipeline Runner
echo ========================================
...
:run_pipeline
echo.
echo Starting Investment Debt Securities Streaming Pipeline...
