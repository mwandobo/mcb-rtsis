@echo off
REM Interbank Loans Payable Pipeline Runner for Windows
REM This script sets up the environment and runs the pipeline

echo ========================================
echo Interbank Loans Payable Pipeline Runner
echo ========================================
...
:run_pipeline
echo.
echo Starting Interbank Loans Payable Streaming Pipeline...
