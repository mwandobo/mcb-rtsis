...
class PersonalDataStreamingPipeline:
    ...
    def insert_to_postgres(self, record: PersonalDataRecord, cursor):
        ...
        ON CONFLICT ("customerIdentificationNumber") DO UPDATE SET
            ...
            sstreet = EXCLUDED.sstreet,
            "shouseNumber" = EXCLUDED."shouseNumber",
            "spostalCode" = EXCLUDED."spostalCode",
            sregion = EXCLUDED.sregion,
            sdistrict = EXCLUDED.sdistrict,
            sward = EXCLUDED.sward,
            scountry = EXCLUDED.scountry
        """
