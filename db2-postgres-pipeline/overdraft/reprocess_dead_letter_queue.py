...
def reprocess_dead_letter_queue():
    ...
    try:
        ...
        dead_letter_queue = channel.queue_declare(queue='overdraft_dead_letter', durable=True, passive=True)
        ...
        channel.basic_consume(queue='overdraft_dead_letter', on_message_callback=callback)
