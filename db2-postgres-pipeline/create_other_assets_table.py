#!/usr/bin/env python3
"""
Create other_assets table with camelCase columns
"""

import psycopg2
from config import Config

def create_other_assets_table():
    ...
    CREATE TABLE IF NOT EXISTS other_assets (
        ...
        PRIMARY KEY ("assetType", "transactionDate")
    )
    '''
    ...
    print("✅ other_assets table created with camelCase columns")

if __name__ == "__main__":
    create_other_assets_table()