...
where eomp.EOM_DATE = (current_date -4 days) 
and eomp.year0 IN (2021,2022)
and eomp.LEVEL0=5
...
where b.ACTIVATION_DATE<= (current_date -1 days)  and b.fk_currencyid_curr=curr.ID_CURRENCY)
...
where eom.EOM_DATE =(current_date -1 days)
and eom.year0 IN (2021,2022)
and eom.LEVEL0=5
AND (
(EOM.DEBIT01+ EOM.DEBIT02+ EOM.DEBIT03+ EOM.DEBIT04+ EOM.DEBIT05+ EOM.DEBIT06+ EOM.DEBIT07+ EOM.DEBIT08+
EOM.DEBIT09+ EOM.DEBIT10+ EOM.DEBIT11+ EOM.DEBIT12+ EOM.BAL_SHEET_DB)-
