...
(
    ...
    TMSTMP            DATE,
    UNIT_DISTRICT_FLG CHAR(1),
    constraint IXU_GL_047
        primary key (FK_BDG_ELEMENTID, FK_BDG_CNTR_UNIFK, YEAR0)
);

create unique index I0000386
    on BDG_LNK_TOTAL (FK_BDG_ELEMENTID);

create unique index I0000388
    on BDG_LNK_TOTAL (FK_BDG_CNTR_UNIFK);
