create table CMS_CARD_APPL
(
    APPLICATION_SN       DECIMAL(10) not null
        constraint PK_CARD_APPLIC
            primary key,
    ENTRY_STATUS         CHAR(2),
    EMAIL                CHAR(60),
    MOBILE               CHAR(20),
...
create unique index I0001005
    on CMS_CARD_APPL (FK_CMS_LIMIT_HDCD);

create unique index I0001054
    on CMS_CARD_APPL (FK_CUST_ADDR_CUST, FK_CUST_ADDR_SN);

create unique index I0001062
    on CMS_CARD_APPL (FK_CUST_ID);

create unique index I0001064
    on CMS_CARD_APPL (FK_CRDTYP_GENERIC_HD, FK_CRDTYP_GENERIC_SN);

create unique index I0001066
    on CMS_CARD_APPL (FK_DELTYP_GENERIC_HD, FK_DELTYP_GENERIC_SN);
