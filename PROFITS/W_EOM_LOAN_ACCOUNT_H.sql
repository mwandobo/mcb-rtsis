create table W_EOM_LOAN_ACCOUNT_H
(
    ...
    DEL_NRM_CHRG_CNT              INTEGER,
    DEL_NRM_INST_CNT              INTEGER,
    DEL_NRM_INT_CNT               INTEGER,
    DEL_NRM_LOAN_CNT              INTEGER,
    OV_INST_CNT                   INTEGER,
    DEL_OV_INT_CNT                INTEGER,
    DEL_OV_LOAN_CNT               INTEGER,
    DEL_OV_CHRG_CNT               INTEGER,
    DEL_TRX_DATE                  DATE,
...
create unique index PKH_IXU_EOM_007
    on W_EOM_LOAN_ACCOUNT_H (EOM_DATE, ACCOUNT_NUMBER);
