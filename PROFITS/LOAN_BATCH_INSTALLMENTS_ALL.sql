create table LOAN_BATCH_INSTALLMENTS_ALL
(
    ...
    constraint PK_BTC_INST_ALL
        primary key (TMSTAMP, TRX_USER, INSTALL_SN, REQUEST_DT, REQUEST_SN, REQUEST_PERIOD, REQUEST_TYPE, ACC_TYPE,
                     ACC_UNIT, ACC_SN)
);

create unique index INDX_BTC_INST_ALL
    on LOAN_BATCH_INSTALLMENTS_ALL (ACC_SN, ACC_UNIT, ACC_TYPE, REQUEST_DT);
