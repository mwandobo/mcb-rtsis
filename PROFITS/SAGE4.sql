CREATE VIEW sage4 as

select glg.ACCOUNT_ID, glg.DESCR,curr.SHORT_DESCR,u.CODE, u.UNIT_NAME,
...
where eomp.EOM_DATE =to_date('24-08-2022','dd-mm-yyyy')
and eomp.year0='2022'
and eomp.LEVEL0=5
...
where b.ACTIVATION_DATE<=to_date('25-08-2022','dd-mm-yyyy') and b.fk_currencyid_curr=curr.ID_CURRENCY)
...
where eom.EOM_DATE =to_date('25-08-2022','dd-mm-yyyy')
and eom.year0='2022'
and eom.LEVEL0=5
AND (
(EOM.DEBIT01+ EOM.DEBIT02+ EOM.DEBIT03+ EOM.DEBIT04+ EOM.DEBIT05+ EOM.DEBIT06+ EOM.DEBIT07+ EOM.DEBIT08+
