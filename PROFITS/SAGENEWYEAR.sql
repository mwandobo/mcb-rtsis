...
where eomp.EOM_DATE= to_date('03-04-2021','dd-mm-yyyy')
and eomp.year0 in (2020,2021)
and eomp.LEVEL0=5
...
where b.ACTIVATION_DATE<=to_date('06-04-2021','dd-mm-yyyy')  and b.fk_currencyid_curr=curr.ID_CURRENCY)
...
where eom.EOM_DATE =to_date('06-04-2021','dd-mm-yyyy')
and eom.year0 in (2020,2021)
and eom.LEVEL0=5
AND (
(EOM.DEBIT01+ EOM.DEBIT02+ EOM.DEBIT03+ EOM.DEBIT04+ EOM.DEBIT05+ EOM.DEBIT06+ EOM.DEBIT07+ EOM.DEBIT08+
EOM.DEBIT09+ EOM.DEBIT10+ EOM.DEBIT11+ EOM.DEBIT12+ EOM.BAL_SHEET_DB)-
