create table BDG_DISTRICT_TOTAL
(
    FK_BDG_ELEMENTID  CHAR(30) not null,
    FK_BDG_DISTRICTID CHAR(3)  not null,
    ...
    TMSTMP            DATE,
    constraint IXU_GL_020
        primary key (FK_BDG_ELEMENTID, FK_BDG_DISTRICTID, YEAR0)
);

create unique index I0000357
    on BDG_DISTRICT_TOTAL (FK_BDG_ELEMENTID);

create unique index I0000359
    on BDG_DISTRICT_TOTAL (FK_BDG_DISTRICTID);
